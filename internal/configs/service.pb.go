...
var file_configs_service_proto_goTypes = []any{
	...
	(*ServiceConfig_Middleware)(nil),         // 5: origadmin.configs.ServiceConfig.Build
	(*ServiceConfig_Middleware_Metrics)(nil), // 6: origadmin.configs.ServiceConfig.Build.Metrics
	(*ServiceConfig_Middleware_Traces)(nil),  // 7: origadmin.configs.ServiceConfig.Build.Traces
	(*ServiceConfig_Middleware_Logger)(nil),  // 8: origadmin.configs.ServiceConfig.Build.Logger
	(*ServiceConfig_Middleware_Cors)(nil),    // 9: origadmin.configs.ServiceConfig.Build.Cors
...
var file_configs_service_proto_depIdxs = []int32{
	...
	5,  // 8: origadmin.configs.ServiceConfig.middleware:type_name -> origadmin.configs.ServiceConfig.Build
	...
	6,  // 25: origadmin.configs.ServiceConfig.Build.metrics:type_name -> origadmin.configs.ServiceConfig.Build.Metrics
	7,  // 26: origadmin.configs.ServiceConfig.Build.traces:type_name -> origadmin.configs.ServiceConfig.Build.Traces
	8,  // 27: origadmin.configs.ServiceConfig.Build.logger:type_name -> origadmin.configs.ServiceConfig.Build.Logger
