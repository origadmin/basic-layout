...
//go:generate protoc -I. -I../third_party -I../toolkits --go_out=paths=source_relative:../internal ./configs/*.proto
//go:generate protoc -I. -I../third_party -I../toolkits --validate_out=paths=source_relative,lang=go:../internal  ./configs/*.proto
