...
func _Greeter_PostHello0_GIN_Handler(srv GreeterGINServer) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		...
		gins.SetOperation(ctx, Greeter_PostHello_OperationName)
		newCtx := gins.NewContext(ctx)
...
func _Greeter_CreateGreeter0_GIN_Handler(srv GreeterGINServer) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		...
		gins.SetOperation(ctx, Greeter_CreateGreeter_OperationName)
		newCtx := gins.NewContext(ctx)
...
func _Greeter_UpdateGreeter0_GIN_Handler(srv GreeterGINServer) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		...
		gins.SetOperation(ctx, Greeter_UpdateGreeter_OperationName)
		newCtx := gins.NewContext(ctx)
...
func _Greeter_DeleteGreeter0_GIN_Handler(srv GreeterGINServer) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		...
		gins.SetOperation(ctx, Greeter_DeleteGreeter_OperationName)
		newCtx := gins.NewContext(ctx)
...
func _Greeter_GetGreeter0_GIN_Handler(srv GreeterGINServer) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		...
		gins.SetOperation(ctx, Greeter_GetGreeter_OperationName)
		newCtx := gins.NewContext(ctx)
...
func _Greeter_ListGreeter0_GIN_Handler(srv GreeterGINServer) func(ctx *gin.Context) {
	return func(ctx *gin.Context) {
		...
		gins.SetOperation(ctx, Greeter_ListGreeter_OperationName)
		newCtx := gins.NewContext(ctx)
...
type GreeterGINClient interface {
	CreateGreeter(ctx context.Context, req *CreateGreeterRequest, opts ...gins.CallOption) (rsp *CreateGreeterReply, err error)
	DeleteGreeter(ctx context.Context, req *DeleteGreeterRequest, opts ...gins.CallOption) (rsp *DeleteGreeterReply, err error)
	GetGreeter(ctx context.Context, req *GetGreeterRequest, opts ...gins.CallOption) (rsp *GetGreeterReply, err error)
	ListGreeter(ctx context.Context, req *ListGreeterRequest, opts ...gins.CallOption) (rsp *ListGreeterReply, err error)
	PostHello(ctx context.Context, req *GreeterRequest, opts ...gins.CallOption) (rsp *GreeterReply, err error)
	SayHello(ctx context.Context, req *GreeterRequest, opts ...gins.CallOption) (rsp *GreeterReply, err error)
	UpdateGreeter(ctx context.Context, req *UpdateGreeterRequest, opts ...gins.CallOption) (rsp *UpdateGreeterReply, err error)
}
...
func (c *GreeterGINClientImpl) CreateGreeter(ctx context.Context, in *CreateGreeterRequest, opts ...gins.CallOption) (*CreateGreeterReply, error) {
	var out CreateGreeterReply
	pattern := "/api/v1/greeter"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, gins.Operation(Greeter_CreateGreeter_OperationName))
...
func (c *GreeterGINClientImpl) DeleteGreeter(ctx context.Context, in *DeleteGreeterRequest, opts ...gins.CallOption) (*DeleteGreeterReply, error) {
	var out DeleteGreeterReply
	pattern := "/api/v1/greeter/{id}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, gins.Operation(Greeter_DeleteGreeter_OperationName))
	opts = append(opts, gins.PathTemplate(pattern))
...
func (c *GreeterGINClientImpl) GetGreeter(ctx context.Context, in *GetGreeterRequest, opts ...gins.CallOption) (*GetGreeterReply, error) {
	var out GetGreeterReply
	pattern := "/api/v1/greeter/{id}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, gins.Operation(Greeter_GetGreeter_OperationName))
	opts = append(opts, gins.PathTemplate(pattern))
...
func (c *GreeterGINClientImpl) ListGreeter(ctx context.Context, in *ListGreeterRequest, opts ...gins.CallOption) (*ListGreeterReply, error) {
	var out ListGreeterReply
	pattern := "/api/v1/greeter"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, gins.Operation(Greeter_ListGreeter_OperationName))
	opts = append(opts, gins.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *GreeterGINClientImpl) PostHello(ctx context.Context, in *GreeterRequest, opts ...gins.CallOption) (*GreeterReply, error) {
	var out GreeterReply
	pattern := "/api/v1/greeter/{id}/hello"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, gins.Operation(Greeter_PostHello_OperationName))
	opts = append(opts, gins.PathTemplate(pattern))
...
func (c *GreeterGINClientImpl) SayHello(ctx context.Context, in *GreeterRequest, opts ...gins.CallOption) (*GreeterReply, error) {
	var out GreeterReply
	pattern := "/api/v1/greeter/{id}/hello"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *GreeterGINClientImpl) UpdateGreeter(ctx context.Context, in *UpdateGreeterRequest, opts ...gins.CallOption) (*UpdateGreeterReply, error) {
	var out UpdateGreeterReply
	pattern := "/api/v1/greeter/{id}"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, gins.Operation(Greeter_UpdateGreeter_OperationName))
	opts = append(opts, gins.PathTemplate(pattern))
