...
// 	protoc        v5.28.3
// source: internal/conf/bootstrap.proto
...
func (x *Bootstrap) Reset() {
	*x = Bootstrap{}
	mi := &file_internal_conf_bootstrap_proto_msgTypes[0]
...
func (*Bootstrap) Descriptor() ([]byte, []int) {
	return file_internal_conf_bootstrap_proto_rawDescGZIP(), []int{0}
}
...
var File_internal_conf_bootstrap_proto protoreflect.FileDescriptor

const file_internal_conf_bootstrap_proto_rawDesc = "" +
	"\n" +
	"\x1dinternal/conf/bootstrap.proto\x12\x04conf\x1a\x18runtime/app/v1/app.proto\x1a\x1eruntime/broker/v1/broker.proto\x1a\x1aruntime/data/v1/data.proto\x1a$runtime/discovery/v1/discovery.proto\x1a\x1eruntime/logger/v1/logger.proto\x1a&runtime/middleware/v1/middleware.proto\x1a\"runtime/security/v1/security.proto\x1a\x1cruntime/trace/v1/trace.proto\x1a$runtime/transport/v1/transport.proto\"\xad\x04\n" +
	"\tBootstrap\x12%\n" +
	...
	"\aclients\x18\n" +
	" \x01(\v2\x1d.runtime.transport.v1.ClientsR\aclientsB\x14Z\x12internal/conf;confb\x06proto3"

var (
	file_internal_conf_bootstrap_proto_rawDescOnce sync.Once
	file_internal_conf_bootstrap_proto_rawDescData []byte
)

func file_internal_conf_bootstrap_proto_rawDescGZIP() []byte {
	file_internal_conf_bootstrap_proto_rawDescOnce.Do(func() {
		file_internal_conf_bootstrap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_conf_bootstrap_proto_rawDesc), len(file_internal_conf_bootstrap_proto_rawDesc)))
	})
	return file_internal_conf_bootstrap_proto_rawDescData
}

var file_internal_conf_bootstrap_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_internal_conf_bootstrap_proto_goTypes = []any{
...
var file_internal_conf_bootstrap_proto_depIdxs = []int32{
	1,  // 0: conf.Bootstrap.app:type_name -> runtime.app.v1.App
	2,  // 1: conf.Bootstrap.servers:type_name -> runtime.transport.v1.Servers
	3,  // 2: conf.Bootstrap.data:type_name -> runtime.data.v1.Data
	4,  // 3: conf.Bootstrap.logger:type_name -> runtime.logger.v1.Logger
	5,  // 4: conf.Bootstrap.trace:type_name -> runtime.trace.v1.Trace
	6,  // 5: conf.Bootstrap.discoveries:type_name -> runtime.discovery.v1.Discoveries
	7,  // 6: conf.Bootstrap.brokers:type_name -> runtime.broker.v1.Brokers
	8,  // 7: conf.Bootstrap.middlewares:type_name -> runtime.middleware.v1.Middlewares
	9,  // 8: conf.Bootstrap.security:type_name -> runtime.security.v1.Security
	10, // 9: conf.Bootstrap.clients:type_name -> runtime.transport.v1.Clients
...
func init() { file_internal_conf_bootstrap_proto_init() }
func file_internal_conf_bootstrap_proto_init() {
	if File_internal_conf_bootstrap_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_conf_bootstrap_proto_rawDesc), len(file_internal_conf_bootstrap_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_internal_conf_bootstrap_proto_goTypes,
		DependencyIndexes: file_internal_conf_bootstrap_proto_depIdxs,
		MessageInfos:      file_internal_conf_bootstrap_proto_msgTypes,
	}.Build()
	File_internal_conf_bootstrap_proto = out.File
	file_internal_conf_bootstrap_proto_goTypes = nil
	file_internal_conf_bootstrap_proto_depIdxs = nil
}
